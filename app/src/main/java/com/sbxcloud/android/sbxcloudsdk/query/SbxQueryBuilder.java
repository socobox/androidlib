...
public class SbxQueryBuilder {
    ...
    private SbxQueryBuilder setReferenceJoin(OP op, String filterField,String referenceField, String model ,Object value) throws JSONException {
        ...
        referenceJoin.put("filter", filter);
        return this;
    }
